                                ...
                                <table width="480" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td> <?php
                                            ...
                                            $times = $result[looktime] + 1;
                                            $sql2 = mysql_query("UPDATE tb_article SET looktime = $times WHERE id = $file_id1;");
                                            ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($bool) {
                                                            ...
                                                            <a href="del_comment.php?comment_id=<?php echo $result[id] ?>"><img
                                                                        src="images/A_delete.gif" width="52" height="16"
                                                                        alt="删除博客文章评论" onClick="return d_chk();"></a>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
                        ...
                        <form name="myform" method="post" action="check_comment.php">
                            <table width="560" border="1" align="center" cellpadding="3" cellspacing="1"
                                ...
                                <td height="112" align="center" valign="top">
                                    ...
                                    <table width="500" border="1" cellpadding="1" cellspacing="0" bordercolor="#D6E7A5"
                                           bgcolor="#FFFFFF">
                                        <tr>
