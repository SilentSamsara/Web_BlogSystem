                            ...
                            <tr>
                                <td height="291" align="center" valign="top">
                                    <table width="600" border="1" align="center" cellpadding="3" cellspacing="1"
                                        ...
                                        //***********************************
                                        $sql = mysql_query("select * from tb_user order by id desc");
                                        $message_count =mysql_num_rows($sql);
                                        $page_count = ceil($message_count/$page_size);
                                            for ( $i = 1 ; $i < 2 ; $i++ ) {
                                                if ($i == 1) {
                                                    $tool = ($page-1)*2;
                                                    $sql = mysql_query("select * from tb_user order by id desc limit $tool,$page_size");
                                                    if ($sql != null)
                                                        ...
                                                        <td height="184" align="center" valign="middle">
                                                            <table width="540" border="1" align=center cellpadding=3
                                                                ...
                                                                <tr bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td colspan="3"
                                                                        align="left"><?php echo $result[password]; ?></td>
                                                                </tr>
                                                                <tr bgcolor="#FFFFFF">
                                                                ...
                                                                <tr bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td align="left"><?php
                                                                        if ($_SESSION[fig] = 1) {
                                                                            ?>
                                                                            <a href="del_user.php?user_id=<?php echo $result[id]; ?>"><img
                                                                                        src="images/A_delete.gif" width="52"
                                                                                        height="16" alt="删除用户信息"
