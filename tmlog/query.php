                            ...
                            <tr>
                                <td height="223" align="center" valign="top">
                                    ...
                                    if (isset($_POST[sel_key])) {
                                        ...
                                        $key = $_POST[sel_key];
                                        if ($tj == "title")
                                            $rst = mysql_query("SELECT * FROM tb_article WHERE title LIKE \"%{$key}%\" OR content LIKE \"%{$key}%\"
                                                                        ORDER BY subtime DESC ");
                                        else if ($tj == "author")
                                            $rst = mysql_query("SELECT * FROM tb_article WHERE author LIKE \"%{$key}%\" ORDER BY subtime DESC");
                                        if (mysql_num_rows($rst) == 0) {
                                            if ($tj == "title")
                                                echo "[<font color=red>没有包含该关键字的文章或标题</font>]";
                                            else if ($tj == "author")
                                                echo "[<font color=red>该作者不存在</font>]";
                                            ...
                                            <table width="560" border="1" align="center" cellpadding="3" cellspacing="1"
                                                ...
                                                <tr align="left" colspan="2">
                                                    <td width="390" height="25" colspan="3" valign="top"
                                                        bgcolor="#EFF7DE"><span class="tableBorder_LTR"> 博客文章</span>
                                                    </td>
                                                </tr>
                                                                ...
                                                                do {
                                                                    ...
                                                                    <table width="100%" border="1" cellpadding="1"
                                                                        ...
                                                                        <tr bgcolor="#FFFFFF">
                                                                            ...
                                                                            <td width="30%"><?php echo $result[subtime]; ?></td>
                                                                        </tr>
                                                                        <tr bgcolor="#FFFFFF">
                                                                        ...
                                                                        <tr bgcolor="#FFFFFF">
                                                                            <td colspan="3" align="center"><a
                                                                                        href="comment.php?file_id=<?php echo $result[id]; ?>">发表评论</a>
                                                                            </td>
