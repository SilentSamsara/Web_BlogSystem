            ...
            <TABLE
                ...
                <TR>
                    <TD height="29" align="center" valign="middle">
                        <TABLE style="WIDTH: 580px" VERTICAL-ALIGN: text-top; cellSpacing=0 cellPadding=0
                               align="center">
                            <TBODY>
                            <TR align="center" valign="middle">
                                <TD style="WIDTH: 100px; COLOR: red;">欢迎您:&nbsp;<?php echo $_SESSION[username]; ?>&nbsp;&nbsp;</TD>
                                <TD style="WIDTH: 80px; COLOR: red;"><SPAN
                                            style="FONT-SIZE: 9pt; COLOR: #cc0033"></SPAN> <a href="index.php">博客首页</a>
                                </TD>
                                <TD style="WIDTH: 80px; COLOR: red;"><A href="RegPro.php"> </A><a
                                    ...
                                    <table width="600" border="1" align="center" cellpadding="3" cellspacing="1"
                                        ...
                                        <tr align="left" colspan="2">
                                            <td width="390" height="25" colspan="3" valign="top" bgcolor="#EFF7DE"><span
                                                        class="tableBorder_LTR">浏览图片</span></td>
                                        </tr>
                                        ...
                                        <td height="192" align="center" valign="top"><?php
                                            ...
                                            $query = "select count(*) as total from tb_tpsc order by subtime desc";
                                            ...
                                            $query = "select * from tb_tpsc where subtime order by id desc limit $offset, $page_size";
                                            $result = mysql_query($query);
                                            ?>
                                            <table width="496" border="1" align="center" cellpadding="3" cellspacing="1"
                                                   bordercolor="#D6D7D6">
                                                <tr>
                                                    <?php
                                                    $i = 1;
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <div align="center"><img
                                                                                src="image.php?recid=<?php echo $info[id]; ?>"
                                                                                width="225" height="160"></div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="109" height="25" align="left">
                                                                    &nbsp;图片名称:<?php echo $info[tpmc]; ?></td>
                                                                <td width="128">上传时间:<?php echo $info[subtime]; ?></td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    <td width="500" height="180">
                                                        <table width="236" height="185" border="0" cellpadding="0"
                                                               cellspacing="0">
                                                            <tr>
