...
<TABLE width="757" cellPadding=0 cellSpacing=0 align="center" style="WIDTH: 755px">
  <TBODY> 
...
<?php
			...
			?>
				<font color="red"><?php echo $_SESSION[username]; ?></font>&nbsp;&nbsp;欢迎您的光临！！！当前时间：<font color="red"><?php echo date("Y-m-d l"); ?>
</font>
			<?
				}
			?>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td align="left" class='f_one'><table width="106" cellpadding="0" cellspacing="0"> 
                  <tr> 
                    ...
                    <td width="80"><img src=" images/head/0.jpg" name="img" width="60" height="60"></td> 
                    <td width="53" rowspan="2" align="center"><font color=red>*</font></td> 
                  </tr> 
                  <tr> 
                    <td>&nbsp;</td> 
                    <td> <select name="txt_ico" size="1" id="txt_ico" onChange="showlogo()"> 
                        <option value="0.jpg" selected>头像1
                        <option value="1.jpg">头像2
                        <option value="2.jpg">头像3
                        <option value="3.jpg">头像4</option> 
                        <option value="4.jpg">头像5</option> 
                        <option value="5.jpg">头像6</option> 
                      </select> </td> 
                  </tr> 
              </table></td> 
            </tr> 
